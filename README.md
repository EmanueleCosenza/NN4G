...
## CLI implementation
`pynn4g` has been implemented using the standard Python module for argument parsing, argparse. In `pynn4g.py`, different actions are taken for each `pynn4g` command, using functionalities from all the other modules.
